...
import com.github.hummel.drealm.entity.EntityRedDwarfMerchant;
import com.github.hummel.drealm.init.SpawnLists;
import com.github.hummel.drealm.structure.StructureRedMountainsHouse;
import com.github.hummel.drealm.structure.StructureRedMountainsSmithy;
import com.github.hummel.drealm.structure.StructureRedMountainsStronghold;
...
public class BiomeRedMountains extends LOTRBiome {
	public BiomeRedMountains(int i, boolean major) {
		super(i, major);
		npcSpawnList.clear();
		LOTRBiomeSpawnList.SpawnListContainer[] arrspawnListContainer = new LOTRBiomeSpawnList.SpawnListContainer[1];
		arrspawnListContainer[0] = LOTRBiomeSpawnList.entry(SpawnLists.redDwarves, 10);
		...
		decorator.addRandomStructure(new StructureRedMountainsStronghold(false), 200);
		decorator.addRandomStructure(new StructureRedMountainsSmithy(false), 75);
		registerMountainsFlowers();
		addFlower(LOTRMod.dwarfHerb, 0, 1);
		biomeColors.setSky(13541522);
		registerTravellingTrader(EntityRedDwarfMerchant.class);
	...
	public void decorate(World world, Random random, int i, int k) {
		...
		WorldGenerator str = new StructureRedMountainsHouse(false);
		for (int l = 0; l < 4; ++l) {
