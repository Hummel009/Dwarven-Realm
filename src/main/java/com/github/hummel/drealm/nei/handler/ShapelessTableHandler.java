package com.github.hummel.drealm.nei.handler;
...
public class ShapelessTableHandler extends ShapelessRecipeHandler {
	private final List<IRecipe> recipeList;
	private final Class<? extends GuiContainer> guiClass;
	private final String recipeName;

	public ShapelessTableHandler(List<IRecipe> recipes, Class<? extends GuiContainer> gui, String name) {
		recipeList = recipes;
		guiClass = gui;
		recipeName = name;
	}
	...
	public String getRecipeName() {
		return StatCollector.translateToLocal("container.lotr.crafting." + recipeName);
	}
	...
	public TemplateRecipeHandler newInstance() {
		return new ShapelessTableHandler(recipeList, guiClass, recipeName);
	}
