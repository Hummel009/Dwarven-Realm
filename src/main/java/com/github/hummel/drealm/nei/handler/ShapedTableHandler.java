...
public class ShapedTableHandler extends ShapedRecipeHandler {
	private final List<IRecipe> recipeList;
	private final Class<? extends GuiContainer> guiClass;
	private final String recipeName;

	public ShapedTableHandler(List<IRecipe> recipes, Class<? extends GuiContainer> gui, String name) {
		recipeList = recipes;
		guiClass = gui;
		recipeName = name;
	}
	...
	public TemplateRecipeHandler newInstance() {
		return new ShapedTableHandler(recipeList, guiClass, recipeName);
	}
