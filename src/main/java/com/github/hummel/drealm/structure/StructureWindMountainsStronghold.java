...
import com.github.hummel.drealm.entity.EntityWindDwarfAxeThrower;
import com.github.hummel.drealm.entity.EntityWindDwarfCommander;
import com.github.hummel.drealm.entity.EntityWindDwarfWarrior;
...
public class StructureWindMountainsStronghold extends LOTRWorldGenStructureBase {
	public StructureWindMountainsStronghold(boolean flag) {
		super(flag);
	}

	private static void spawnDwarf(World world, int i, int j, int k) {
		EntityWindDwarfWarrior dwarf = world.rand.nextInt(3) == 0 ? new EntityWindDwarfAxeThrower(world) : new EntityWindDwarfWarrior(world);
		dwarf.setLocationAndAngles(i + 0.5, j, k + 0.5, 0.0f, 0.0f);
		((EntityWindDwarf) dwarf).onSpawnWithEgg(null);
	...
	private static void spawnDwarfCommander(World world, int i, int j, int k) {
		EntityWindDwarfCommander dwarf = new EntityWindDwarfCommander(world);
		dwarf.setLocationAndAngles(i + 0.5, j, k + 0.5, 0.0f, 0.0f);
	...
	public boolean generate(World world, Random random, int i, int j, int k) {
		...
		int j2 = j;
		Block block;
		if (restrictions && (block = world.getBlock(i3, j2 - 1, k3)) != net.minecraft.init.Blocks.grass && block != net.minecraft.init.Blocks.stone && block != net.minecraft.init.Blocks.dirt && block != net.minecraft.init.Blocks.stained_hardened_clay && block != net.minecraft.init.Blocks.snow) {
			return false;
		}
		--j2;
		...
		for (k1 = k3 - 6; k1 <= k3 + 6; ++k1) {
			for (i1 = i3 - 6; i1 <= i3 + 6; ++i1) {
				...
				for (int j1 = j2 + 7; (j1 >= j2 || !LOTRMod.isOpaque(world, i1, j1, k1)) && j1 >= 0; --j1) {
					if (flag) {
						setBlockAndNotifyAdequately(world, i1, j1, k1, Blocks.pillar, 0);
					} else {
						...
						setBlockAndNotifyAdequately(world, i1, j1, k1, Blocks.brick, 0);
					}
					if (j1 > j2) {
						continue;
					}
		...
		for (k1 = k3 - 5; k1 <= k3 + 5; ++k1) {
			for (i1 = i3 - 5; i1 <= i3 + 5; ++i1) {
				setBlockAndNotifyAdequately(world, i1, j2 + 4, k1, Blocks.slabDouble, 0);
				setBlockAndNotifyAdequately(world, i1, j2 + 8, k1, Blocks.slabDouble, 0);
				...
				setBlockAndNotifyAdequately(world, i1, j2 + 9, k1, Blocks.wall, 0);
			}
		}
		...
		setBlockAndNotifyAdequately(world, i3, j2 + 7, k3, Blocks.chandelier, 1);
		setBlockAndNotifyAdequately(world, i3, j2 + 11, k3, Blocks.chandelier, 1);
		...
		respawner.setSpawnClasses(EntityWindDwarfWarrior.class, EntityWindDwarfAxeThrower.class);
	...
	private void generateFacingEast(World world, Random random, int i, int j, int k) {
		...
		for (k12 = k - 6; k12 <= k + 6; ++k12) {
			setBlockAndNotifyAdequately(world, i - 7, j + 1, k12, Blocks.slabSingle, 0);
			setGrassToDirt(world, i - 7, j, k12);
			for (j1 = j; !LOTRMod.isOpaque(world, i - 7, j1, k12) && j1 >= 0; --j1) {
				setBlockAndNotifyAdequately(world, i - 7, j1, k12, Blocks.pillar, 0);
		...
		for (j12 = j + 1; j12 <= j + 2; ++j12) {
			...
			setBlockAndNotifyAdequately(world, i - 7, j12, k - 1, Blocks.pillar, 0);
			setBlockAndNotifyAdequately(world, i - 7, j12, k + 1, Blocks.pillar, 0);
		}
		...
		placeWallBanner(world, i - 6, j + 6, k, 1, BannerTypes.windMountains);
		int k13;
		int i1;
		for (j12 = j + 1; j12 <= j + 3; ++j12) {
			for (i1 = i - 4; i1 <= i - 1; ++i1) {
				for (k13 = k - 5; k13 <= k - 1; ++k13) {
					setBlockAndNotifyAdequately(world, i1, j12, k13, Blocks.brick, 0);
				}
			...
			for (i1 = i - 2; i1 <= i + 5; ++i1) {
				setBlockAndNotifyAdequately(world, i1, j12, k - 1, Blocks.brick, 0);
				setBlockAndNotifyAdequately(world, i1, j12, k + 1, Blocks.brick, 0);
			}
		}
		...
		for (k12 = k - 5; k12 <= k + 2; k12 += 7) {
			...
			LOTRChestContents.fillChest(world, random, i, j + 1, k12 + 2, ChestContents.windMountainsStronghold);
			setBlockAndNotifyAdequately(world, i + 3, j + 3, k12 + 1, Blocks.chandelier, 1);
		...
		for (k1 = k - 5; k1 <= k + 5; k1 += 10) {
			...
			setBlockAndNotifyAdequately(world, i + 2, j + 5, k1, net.minecraft.init.Blocks.planks, 1);
			setBlockAndNotifyAdequately(world, i + 2, j + 6, k1, net.minecraft.init.Blocks.wooden_slab, 1);
			setBlockAndNotifyAdequately(world, i, j + 5, k1, Blocks.windDwarvenTable, 0);
		...
		setBlockAndNotifyAdequately(world, i + 6, j + 4, k, Blocks.slabDouble, 0);
		...
		setBlockAndNotifyAdequately(world, i + 8, j + 3, k, Blocks.chandelier, 1);
	...
	private void generateFacingNorth(World world, Random random, int i, int j, int k) {
		...
		for (i12 = i - 6; i12 <= i + 6; ++i12) {
			setBlockAndNotifyAdequately(world, i12, j + 1, k + 7, Blocks.slabSingle, 0);
			setGrassToDirt(world, i12, j, k + 7);
			for (j1 = j; !LOTRMod.isOpaque(world, i12, j1, k + 7) && j1 >= 0; --j1) {
				setBlockAndNotifyAdequately(world, i12, j1, k + 7, Blocks.pillar, 0);
		...
		for (j12 = j + 1; j12 <= j + 2; ++j12) {
			...
			setBlockAndNotifyAdequately(world, i - 1, j12, k + 7, Blocks.pillar, 0);
			setBlockAndNotifyAdequately(world, i + 1, j12, k + 7, Blocks.pillar, 0);
		}
		...
		placeWallBanner(world, i, j + 6, k + 6, 0, BannerTypes.windMountains);
		int i1;
		int k1;
		for (j12 = j + 1; j12 <= j + 3; ++j12) {
			for (k1 = k + 4; k1 >= k + 1; --k1) {
				for (i1 = i - 5; i1 <= i - 1; ++i1) {
					setBlockAndNotifyAdequately(world, i1, j12, k1, Blocks.brick, 0);
				}
			...
			for (k1 = k + 2; k1 >= k - 5; --k1) {
				setBlockAndNotifyAdequately(world, i - 1, j12, k1, Blocks.brick, 0);
				setBlockAndNotifyAdequately(world, i + 1, j12, k1, Blocks.brick, 0);
			}
		}
		...
		for (i12 = i - 5; i12 <= i + 2; i12 += 7) {
			...
			LOTRChestContents.fillChest(world, random, i12 + 2, j + 1, k, ChestContents.windMountainsStronghold);
			setBlockAndNotifyAdequately(world, i12 + 1, j + 3, k - 3, Blocks.chandelier, 1);
		...
		for (i13 = i - 5; i13 <= i + 5; i13 += 10) {
			...
			setBlockAndNotifyAdequately(world, i13, j + 5, k - 2, net.minecraft.init.Blocks.planks, 1);
			setBlockAndNotifyAdequately(world, i13, j + 6, k - 2, net.minecraft.init.Blocks.wooden_slab, 1);
			setBlockAndNotifyAdequately(world, i13, j + 5, k, Blocks.windDwarvenTable, 0);
		...
		setBlockAndNotifyAdequately(world, i, j + 4, k - 6, Blocks.slabDouble, 0);
		...
		setBlockAndNotifyAdequately(world, i, j + 3, k - 8, Blocks.chandelier, 1);
		for (j1 = j + 1; j1 <= j + 2; ++j1) {
	...
	private void generateFacingSouth(World world, Random random, int i, int j, int k) {
		...
		setBlockAndNotifyAdequately(world, i + 1, j + 3, k - 7, LOTRMod.stairsDwarvenBrick, 1);
		setBlockAndNotifyAdequately(world, i, j + 4, k - 7, LOTRMod.slabSingle, 7);
		placeWallBanner(world, i, j + 6, k - 6, 2, BannerTypes.windMountains);
		int i1;
		int k1;
		for (j12 = j + 1; j12 <= j + 3; ++j12) {
			for (k1 = k - 4; k1 <= k - 1; ++k1) {
	...
	private void generateFacingWest(World world, Random random, int i, int j, int k) {
		...
		setBlockAndNotifyAdequately(world, i + 7, j + 3, k + 1, LOTRMod.stairsDwarvenBrick, 3);
		setBlockAndNotifyAdequately(world, i + 7, j + 4, k, LOTRMod.slabSingle, 7);
		placeWallBanner(world, i + 6, j + 6, k, 3, BannerTypes.windMountains);
		int k13;
		int i1;
		for (j12 = j + 1; j12 <= j + 3; ++j12) {
			for (i1 = i + 4; i1 >= i + 1; --i1) {
	...
	private void placeBalconySection(World world, int i, int j, int k, boolean isEdge, boolean isPillar) {
		if (isEdge) {
			for (int j1 = j + 4; (j1 >= j || !LOTRMod.isOpaque(world, i, j1, k)) && j1 >= 0; --j1) {
				if (isPillar) {
					setBlockAndNotifyAdequately(world, i, j1, k, Blocks.pillar, 0);
				} else {
					setBlockAndNotifyAdequately(world, i, j1, k, Blocks.brick, 0);
				}
			...
			setBlockAndNotifyAdequately(world, i, j + 6, k, Blocks.wall, 0);
		} else {
			int j1;
			...
			setBlockAndNotifyAdequately(world, i, j + 4, k, Blocks.slabDouble, 0);
		}
	}
