...
public class EntityWindDwarfAxeThrower extends EntityWindDwarfWarrior {
	public EntityWindDwarfAxeThrower(World world) {
		super(world);
	}
	...
	public void attackEntityWithRangedAttack(EntityLivingBase target, float f) {
		...
		if (axeItem == null) {
			axeItem = new ItemStack(Items.throwingAxeWindDwarven);
		}
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
		...
		npcItemsInv.setRangedWeapon(new ItemStack(Items.throwingAxeWindDwarven));
