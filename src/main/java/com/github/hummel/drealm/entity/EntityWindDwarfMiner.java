...
public class EntityWindDwarfMiner extends EntityWindDwarf implements LOTRTradeable {
	public EntityWindDwarfMiner(World world) {
		super(world);
	}
	...
	public LOTRTradeEntries getBuyPool() {
		return TradeEntries.windDwarfMinerBuy;
	}

	@Override
	public LOTRTradeEntries getSellPool() {
		return TradeEntries.windDwarfMinerSell;
	}
	...
	public void onPlayerTrade(EntityPlayer entityplayer, LOTRTradeEntries.TradeType type, ItemStack itemstack) {
		LOTRLevelData.getData(entityplayer).addAchievement(Achievements.tradeWindDwarfMiner);
	}

	@Override
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
		IEntityLivingData d = super.onSpawnWithEgg(data);
		npcItemsInv.setMeleeWeapon(new ItemStack(Items.pickaxeWindDwarven));
