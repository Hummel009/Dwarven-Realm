...
public class EntityRedDwarfAxeThrower extends EntityRedDwarfWarrior {
	public EntityRedDwarfAxeThrower(World world) {
		super(world);
	}
	...
	public void attackEntityWithRangedAttack(EntityLivingBase target, float f) {
		...
		if (axeItem == null) {
			axeItem = new ItemStack(Items.throwingAxeRedDwarven);
		}
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
		...
		npcItemsInv.setRangedWeapon(new ItemStack(Items.throwingAxeRedDwarven));
