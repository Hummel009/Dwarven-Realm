...
public class EntityRedDwarfCommander extends EntityRedDwarfWarrior implements LOTRUnitTradeable {
	public EntityRedDwarfCommander(World world) {
		super(world);
	...
	public LOTRUnitTradeEntries getUnits() {
		return UnitTradeEntries.redDwarfCommander;
	}

	@Override
	public LOTRInvasions getWarhorn() {
		return Invasions.redMountains;
	}
	...
	public void onUnitTrade(EntityPlayer entityplayer) {
		LOTRLevelData.getData(entityplayer).addAchievement(Achievements.tradeRedDwarfCommander);
	}
