...
public class DRHandlerTableShapeless extends ShapelessRecipeHandler {
	private final List<IRecipe> recipeList;
	private final Class<? extends GuiContainer> guiClass;
	private final String recipeName;

	public DRHandlerTableShapeless(List<IRecipe> recipes, Class<? extends GuiContainer> gui, String name) {
		recipeList = recipes;
		guiClass = gui;
		recipeName = name;
	}
	...
	public TemplateRecipeHandler newInstance() {
		return new DRHandlerTableShapeless(recipeList, guiClass, recipeName);
	}
